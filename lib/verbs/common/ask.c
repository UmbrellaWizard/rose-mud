...
mixed can_ask_liv_to_str(string str) { 
    if(GUEST_CHECK == "guest") return "You can't do that.";   
    else return 1; 
}

mixed can_ask_liv_for_str(string str) { 
    if(GUEST_CHECK == "guest") return "You can't do that.";
    else return 1; 
}

mixed can_ask_liv_about_str(string str) { 
    if(GUEST_CHECK == "guest") return "You can't do that.";
    else return 1; 
}
...
mixed can_ask_liv_str(string str) {
    ...
    if(GUEST_CHECK == "guest") return "You can't do that.";
    else if( sscanf(str, "to %s", tmp) ) return 1;
...
mixed can_ask_str(string str) {
    if(GUEST_CHECK == "guest") return "You can't do that.";
    else return this_player()->CanSpeak(0, TALK_LOCAL, str);;
}
